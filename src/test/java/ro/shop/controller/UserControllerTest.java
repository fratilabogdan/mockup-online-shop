...
//        System.out.println(userController.getUser(idUser));
    }
    ...
    public void testDuplicateMail(){
        String mail = userController.getUser(idUser).getEmail();
        assertEquals(true, userController.duplicateMail(mail));
    }

    @Test
    public void testValidMailText(){
        String mail = userController.getUser(idUser).getEmail();
        assertEquals(true, userController.validMailText(mail));
    }

    @Test
    public void testValidMail() {
        String mail = "testingmailvalid@gmail.com";
        assertEquals(true, userController.validMailText(mail));
    }
    ...
    public void testGetUserByMail(){
        assertEquals(true, userController.getUserByMail("TestEmail@test.com").getEmail().equals("TestEmail@test.com"));
    }

    @Test
    public void testUpdateTrialDays(){
        User validUser = new Guest("guest2mail@test.com","TestPassword", "Guest Name Valid", "Guest address valid",9);


        int id= userController.lastID()+1;

        userController.add(validUser);

        System.out.println(userController.getUserByMail("guest2mail@test.com") instanceof Guest);

        System.out.println(userController.getUserByMail("guest2mail@test.com"));
        id = userController.getUserByMail("guest2mail@test.com").getId();
        userController.updateTrialDays(id,7);
        assertEquals(7, ((Guest)userController.getUser(id)).getTrialDays());
